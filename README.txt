This project is a simulation of a tire monitoring system. This project was made using C++ in Arduino IDE. The components used are: 
-1 DHT11;
...
-jumpwires.
For the sake of the project, I had to give fictional values to each threshold, since this project is only meant to show the basics of the tire monitoring system and is only for educational purpose.
