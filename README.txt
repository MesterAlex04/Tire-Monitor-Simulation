...
-jumpwires.
For the sake of the project, I had to give fictional values to the threshold values, since this project is only meant to show the basics of the tire monitoring system.
